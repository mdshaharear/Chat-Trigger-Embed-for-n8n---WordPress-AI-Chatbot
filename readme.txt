...
3. Configure the n8n production Chat Trigger URL.
4. Add your WordPress origin to Allowed Origins in n8n.
5. If you use Elementor, drag the `AI Chat Builder` widget into your layout.
